...
#include "../libreprobe-utils/extensions/templates.c"
#else
#ifdef HAVE_TEMPLATE_EXTENSIONS
#include "templates.c"
#endif
...
V9V10TemplateElementId ver9_templates[] = {
  ...
  */
  ...
  { 0, BOTH_IPV4_IPV6, FLOW_TEMPLATE, SHORT_SNAPLEN, NTOP_ENTERPRISE_ID,   CLIENT_NW_DELAY_SEC,  STATIC_FIELD_LEN, 4, numeric_format, dump_as_uint,  "CLIENT_NW_DELAY_SEC", "",  "Network latency client <-> libreprobe (sec) [deprecated]" },
  { 0, BOTH_IPV4_IPV6, FLOW_TEMPLATE, SHORT_SNAPLEN, NTOP_ENTERPRISE_ID,   CLIENT_NW_DELAY_USEC,  STATIC_FIELD_LEN, 4, numeric_format, dump_as_uint,  "CLIENT_NW_DELAY_USEC", "", "Network latency client <-> libreprobe (residual usec) [deprecated]" },
#endif
  { 0, BOTH_IPV4_IPV6, FLOW_TEMPLATE, SHORT_SNAPLEN, NTOP_ENTERPRISE_ID,   CLIENT_NW_LATENCY_MS,  STATIC_FIELD_LEN, 4, numeric_format, dump_as_uint,  "CLIENT_NW_LATENCY_MS", "", "Network RTT/2 client <-> libreprobe (msec)" },

#ifdef DEPRECATED_INFORMATION_ELEMENTS
  { 0, BOTH_IPV4_IPV6, FLOW_TEMPLATE, SHORT_SNAPLEN, NTOP_ENTERPRISE_ID,   SERVER_NW_DELAY_SEC,  STATIC_FIELD_LEN, 4, numeric_format, dump_as_uint,  "SERVER_NW_DELAY_SEC", "",  "Network latency libreprobe <-> server (sec) [deprecated]" },
  { 0, BOTH_IPV4_IPV6, FLOW_TEMPLATE, SHORT_SNAPLEN, NTOP_ENTERPRISE_ID,   SERVER_NW_DELAY_USEC,  STATIC_FIELD_LEN, 4, numeric_format, dump_as_uint,  "SERVER_NW_DELAY_USEC", "", "Network latency libreprobe <-> server (residual usec) [deprecated]" },
#endif
  { 0, BOTH_IPV4_IPV6, FLOW_TEMPLATE, SHORT_SNAPLEN, NTOP_ENTERPRISE_ID,   SERVER_NW_LATENCY_MS,  STATIC_FIELD_LEN, 4, numeric_format, dump_as_uint,  "SERVER_NW_LATENCY_MS", "", "Network RTT/2 libreprobe <-> server (residual msec)" },
